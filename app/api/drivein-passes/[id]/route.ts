  ...
  try {
    ...
    const result = await sql`
      UPDATE drivein_passes SET
        ...
        friday_dinner = ${friday_dinner || false},
        saturday_breakfast = ${saturday_breakfast || false},
        saturday_lunch = ${saturday_lunch || false},
        saturday_dinner = ${saturday_dinner || false},
        sunday_breakfast = ${sunday_breakfast || false},
        sunday_lunch = ${sunday_lunch || false},
        notes = ${notes || null},
